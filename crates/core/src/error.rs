...
pub enum BrowserError {
    ...
    #[error("CDP: {0}")]
    Cdp(#[from] dig2browser_cdp::CdpError),

    #[error("WebDriver: {0}")]
    WebDriver(#[from] dig2browser_webdriver::WdError),

    #[error("BiDi: {0}")]
    BiDi(#[from] dig2browser_bidi::BiDiError),
...
impl From<dig2browser_detect::DetectError> for BrowserError {
    fn from(e: dig2browser_detect::DetectError) -> Self {
